...
- [ ] **I. Bootstrap-First Styling** — Bootstrap 5 is the primary CSS framework;
...
- [ ] **II. Stitch Design Blueprint** — The relevant `stitch-designs/<feature>/`
  subfolder has been located and consulted; no visual decisions made without it.
- [ ] **III. Angular Standalone Architecture** — Feature lives under
  `src/app/features/<name>/`; no NgModule introduced; standalone components only.
- [ ] **IV. Separation of Concerns** — HTTP/API logic delegated to a Core service;
  model interfaces defined under `src/app/core/models/`; no cross-layer violations.
- [ ] **V. Scope-Lock & Consultation** — Only the requested feature is modified;
